                                ...
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <div class="flex items-center justify-center h-12 w-12 rounded-md  text-white">
                                            <img class="h-10 w-10"
                                                 src="https://ss3.bdstatic.com/yrwDcj7w0QhBkMak8IuT_XF5ehU5bvGh7c50/comt/1586226297_a3024b56d55feaf3205f56396319bcd7_fullsize.jpeg">
                                        </div>
                                    </div>
                                    <div class="ml-4">
                            ...
                            <li class="mt-10 md:mt-0">
                                <div class="flex">
                                    <div class="flex-shrink-0">
                                        <div class="flex items-center justify-center h-12 w-12 rounded-md  text-white">
                                            <img class="h-10 w-10"
                                                 src="https://img5.tianyancha.com/logo/product/0944a006cf4ed154b39fcb68bf0f90d2.png@!f_200x200">
                                        </div>
                                    </div>
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-2 text-base leading-6 text-gray-500">
                                            OfficeBC
                                            是专业的商务中心和联合办公在线租赁平台，免费提供商务中心办公室的租赁咨询、房源推荐、现场带看等一条龙服务，协助您找到合适的办公场所，并能够有效降低租金支出。
                                        </p>
                                    </div>
                                </div>
                            </li>
                            <li class="mt-10 md:mt-0">
                                <div class="flex">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-2 text-base leading-6 text-gray-500">
                                            常德海关地处常德市武陵区武陵大道，是隶属于长沙海关的正处级海关，于
                                            1997年11月3日开关，关区管辖范围为常德市、张家界市、湘西自治州，共2市4区15县，辖区面积43311平方公里
                                        </p>
                                    </div>
                                </div>
                            </li>
