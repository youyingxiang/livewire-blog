...
<div class="page">
    ...
    <form action="{{route('tyfs.update',$recipe->id)}}" method="Post">
        @method('put')
        @csrf
                    ...
                    <div class="weui-cell ">
                        <div class="weui-cell__bd">
                            <textarea class="weui-textarea" name="breakfast" placeholder="请输入早餐食谱"
                                      rows="3">{{old('breakfast') ?? $recipe->breakfast}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="weui-cell ">
                        <div class="weui-cell__bd">
                            <textarea class="weui-textarea" name="lunch" placeholder="请输入午餐食谱"
                                      rows="3">{{old('lunch') ?? $recipe->lunch}}</textarea>
                    ...
                    <div class="weui-cell ">
                        <div class="weui-cell__bd">
                            <textarea class="weui-textarea" name="dinner" placeholder="请输入晚餐食谱"
                                      rows="3">{{old('dinner') ?? $recipe->dinner}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
