                ...
                <div class="lg:w-0 lg:flex-1">
                    <a href="/" class="flex">
                        <img class="h-8 w-auto sm:h-10 rounded-full text-white shadow-solid"
                             src="http://wxy.cdn.0736tw.com/images/24e02b5d4d82a6abd3b638e18bac466f.png" alt="Workflow">
                    </a>
                </div>
            ...
            <div class="rounded-lg shadow-xs bg-white divide-y-2 divide-gray-50">
                <div class="pt-5 pb-6 px-5 space-y-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <img class="h-8 w-auto sm:h-10 rounded-full text-white shadow-solid" src="http://wxy.cdn.0736tw.com/images/24e02b5d4d82a6abd3b638e18bac466f.png"
                                 alt="Workflow">
                        </div>
                        <div class="-mr-2">
                            <button x-on:click="alert('213')" type="button"
                                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                                <!-- Heroicon name: x -->
                                <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
